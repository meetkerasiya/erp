...
router.post("/",[auth],async (req,res)=>{
    ...
    const {err} =validation(req.username,req.body.faculty,req.body.title,req.body.application_no,req.body.date,req.body.status);
    if(err)
    {
    ...
    {/*
        ...
        res.send("This Patent already exists")
    }
    else
    {
...
function validation(username,faculty,title,title,application_no,date,status)
{
