...
router.post("/",[auth],async (req,res)=>{
    ...
    const {err} =validation(req.username,req.body.start_date,req.body.end_date,req.body.expert,req.body.title,req.body.type,req.body.funding_agency);
    if(err)
    {
    ...
    if(check != null)
    {
        res.send("This Faculty_workshop already exists")
    }
    else
    {
...
function validation(username,start_date,end_date,expert,title,type,funding_agency)
{
