...
router.post("/",[auth],async (req,res)=>{
    ...
    const {err} =validation(req.username,req.body.title_talk,req.body.title_program,req.body.title,req.body.date,req.body.vanue);
    if(err)
    {
    ...
    if(check != null)
    {
        res.send("This Expert talk already exists")
    }
    else
    {
