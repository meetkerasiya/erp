...
router.post("/",[auth],async (req,res)=>{
    ...
    const {err} =validation(req.username,req.body.cordinator,req.body.project_title,req.body.funding_agency,req.body.amount);
    if(err)
    {
    ...
    {/*
        ...
        res.send("This Grant already exists")
    }
    else
    {
        let grant=new Grant({
...
function validation(username,cordinator,project_title,project_title,funding_agency,amount)
{
